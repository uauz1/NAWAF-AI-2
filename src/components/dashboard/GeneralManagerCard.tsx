  ...
  return (
    <div className="relative overflow-hidden rounded-2xl glass-panel border border-purple-500/20 p-5 sm:p-6 shadow-[0_0_35px_-10px_rgba(168,85,247,0.15)]">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-base font-bold text-white tracking-tight">ملخص المدير العام الذكي</h3>
              <span className="text-[10px] bg-purple-500/15 text-purple-300 border border-purple-500/30 px-2 py-0.5 rounded-full font-mono">Verified State</span>
            </div>
            <p className="text-xs text-slate-400 mt-0.5">{gmSummary.greeting}</p>
          </div>
        </div>
      ...
      <div className="mb-4 p-3.5 rounded-xl bg-slate-900/70 border border-white/5 text-xs text-slate-300 leading-relaxed">
        <span className="font-semibold text-cyan-300">الحالة الموثقة: </span>
        {gmSummary.headline}
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-2.5 mb-4">
        <div className="p-2.5 rounded-xl bg-slate-950/50 border border-white/5 text-center">
          ...
          <div className="text-[10px] text-slate-400">موظفون بحالة عمل</div>
        </div>
        <div className="p-2.5 rounded-xl bg-slate-950/50 border border-white/5 text-center">
          <div className="text-lg font-bold text-emerald-400 font-mono">{metrics.completedTasks}</div>
          <div className="text-[10px] text-slate-400">مهام مكتملة موثقة</div>
        </div>
        <div className="p-2.5 rounded-xl bg-slate-950/50 border border-white/5 text-center">
          <div className="text-lg font-bold text-amber-400 font-mono">{gmSummary.detectedIssuesCount}</div>
          <div className="text-[10px] text-slate-400">مهام متوقفة</div>
        </div>
        <div className="p-2.5 rounded-xl bg-slate-950/50 border border-white/5 text-center">
          <div className="text-lg font-bold text-cyan-400 font-mono">{gmSummary.newIdeasCount}</div>
          <div className="text-[10px] text-slate-400">أفكار مسجلة</div>
        </div>
        <div className="col-span-2 sm:col-span-1 p-2.5 rounded-xl bg-rose-950/30 border border-rose-500/30 text-center">
          ...
          <div className="text-[10px] text-rose-300 font-medium">قرارات معلقة</div>
        </div>
      </div>
      ...
      <div className="mt-4 pt-3 border-t border-white/[0.06] flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <div className="text-xs text-slate-400">
          <span className="text-amber-300 font-semibold">التركيز المقترح: </span>
